 ...
 * Form e access e.target.[name of the input field].valute;
 * 
 ...
 * 
 * 4. uncntrolled element : useRef to create a reference to the element and access value by using like: nameRef.current.value;
 * 
